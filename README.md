# CMPSC 529 (Internship) Course Syllabus

This repository contains information about the </em>Computer Science Internship</em> course, including the course objectives, expectations, and deliverables.

# Contents

* [Instructor on Record](#Instructor-on-record)
...
- Final presentation
- Continuous engagement as evident by GitHub commits
...
The grade for this course will be based on the feedback from the industry partners, the two presentations, your documented engagement via GitHub, and the status of the completed software tool.
